...
def prepareTestData():
    df = pd.read_csv('datasets/Test_sample.csv')
    ...
    print(phishing_emails.head())
    print(non_phishing_emails.head())
    
    # non_phishing_emails = non_phishing_emails.sample(len(phishing_emails), replace=True)
